  ...
  async redirects() {
    return [
      // 1. Surgical Redirects: Only for pages that exist in Next.js (pages/ directory)
      {
        ...
        source: '/:path(0-c-to-f|4-c-to-f|20-c-to-f|36-c-to-f|36-1-c-to-f|36-3-c-to-f|36-4-c-to-f|37-c-to-f|37-2-c-to-f|37-5-c-to-f|38-c-to-f|39-c-to-f|40-c-to-f|41-c-to-f|47-c-to-f|75-c-to-f|100-c-to-f|about-us|privacy-policy|terms-of-service|c-to-f-calculator|c-to-f-formula|celsius-to-fahrenheit-chart|fahrenheit-to-celsius|fan-oven-conversion-chart|temperature-conversion-challenge|body-temperature-chart-fever-guide).html',
        destination: '/:path',
        statusCode: 301,
      },
      {
